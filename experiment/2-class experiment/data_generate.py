...
def main():
    input_list = [10,30,50,100,150,200,250,300,350,400]
    pred_list = [10]
    feature_list = [5]
    threshold_list = [0.0004,0.0007]
    lstm_list = [32]
    lr_list = [0.01]
    epsilon_list = [1]
    regularizer_list = [0.001]
    ...
    # hyper_df.to_csv('task_new.csv', index=False)
    # sys.exit(0)
    ...
    for index, row in hyper_df.iterrows():
        ...
        if os.path.isfile(os.path.join(save_dir, 'train_y_onehot.npy')):
            continue
        # if os.path.isfile(os.path.join(save_dir, 'valid_y_onehot.npy')):
        #     continue
        ...
        for single_date in date_range(start_date, end_date):
            ...
            #labels 1: equal or greater than label_threshold
            #labels 0: between
            #labels -1: smaller or equal to -label_threshold
            ...
            # delete all flat label
            new_label = new_label[flat_label_num:]
            x = x[flat_label_num:]
            ...
            # make -1 to 0 for 2-class one hot encoding 
        ...
        # print(trade_y.shape)
        # print(trade_y)
        np.save(os.path.join(save_dir, 'train_y_onehot.npy'), trade_y)
        # np.save(os.path.join(save_dir, 'valid_y_onehot.npy'), trade_y)
